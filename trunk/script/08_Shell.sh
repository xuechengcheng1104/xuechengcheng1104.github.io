...
#-------------------------------------------------
# test if the remote port is opened
#-------------------------------------------------
nc -z -w 1 10.31.11.13 1536
#-------------------------------------------------
# grep 输出上下文
#-------------------------------------------------
grep -C 5 foo file #show 5 lines up and down
grep -B 1 -A 3 foo file
#-------------------------------------------------
# display the size of one directory
#-------------------------------------------------
du -sh ./
#-------------------------------------------------
# mv files to trash
...
#-------------------------------------------------
date -d @1479304477
date -d "2016-11-29 00:00:00" +%s
1970-01-01 00:00:00 #unix时间纪元
#-------------------------------------------------
#杀死进程
#-------------------------------------------------
kill -9 4560
